...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_gen_len", type=int, default=1356, help="生成最大长度")
    parser.add_argument("--data_path", type=str, default="../dataset/rlaif-mini.jsonl")
    parser.add_argument("--num_generations", type=int, default=8,  help="每个 prompt 生成几个回答 (G). 越大 advantage 越稳定, 但越慢")
